...
sudo -u "$TARGET_USER" sh "$SCRIPT_DIR/copyconf.sh"
...
sudo cp "$SCRIPT_DIR/deb12-i3/display.sh" /usr/share/display.sh
sudo chown root:root /usr/share/display.sh
sudo chmod 775 /usr/share/display.sh
sudo cp "$SCRIPT_DIR/background.png" /usr/share/background.png
sudo chown root:root /usr/share/background.png
sudo chmod 644 /usr/share/background.png
sudo cp "$SCRIPT_DIR/01_debian.conf" /usr/share/lightdm/lightdm-gtk-greeter.conf.d/01_debian.conf
...
sudo cp "$SCRIPT_DIR/lightdm.conf" /etc/lightdm/lightdm.conf
