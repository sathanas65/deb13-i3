...
===================
This repo hosts a set of install scripts and config files for Debian 13, to automate installation and configuration of the i3 Window Manager and other packages. It is modular and you may enable/disable commands as desired. For best results, install on a a fresh Debian 13 with no GUI environment. 
...
![GitHub Image](/screenshots/screenshot-20260308-025759Z.png)     ![GitHub Image](/screenshots/screenshot-20260308-025502Z.png) 
